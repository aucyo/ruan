...
function load(){
	...
	<div class="daohang">
		<ul class="nav nav-pills nav-stacked">
  		<li role="presentation" class="active"><a href="accuses">举报名单</a></li>
  		<li role="presentation"><a href="#"></a></li>
  		<li role="presentation"><a href="rejects">封禁名单</a></li>
    ...
    <s:iterator value="aaccuses" var="ac">
	    <tr>
	      ...
	      <td><a onclick="return commit();" href="doReject?hisBasic.uid=${ac.user1_id}">封禁</a></td>
	    </tr>
  	</s:iterator>
