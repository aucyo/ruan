...
<script>
function phoneCheck(){
	document.getElementById("ca").innerHtml="<font color='red'>请输入11位数字的有效号码</font>";
	return false;
...
<br>
 ...
 <form method="post" action="pwdCheck">
  	<div class="input-group">
  		...
  		<input id="phone" name="phoneCheck.phone" placeholder="手机号码：" onkeyup="phoneCheck()" type="text" class="form-control" placeholder="电话" aria-describedby="basic-addon2">
  	</div>
  	<div id="ca" style="height: 30px;" align="left"><font color='red'>手机号或密码错误</font></div>
  	<div class="input-group">
  		<span class="input-group-addon" id="basic-addon1"><font color="red">*</font></span>
