...
<br>
 ...
 <form method="post" action="logupsave">
  	<div class="input-group">
  		...
  		<input id="phone" name="phoneCheck.phone" type="number" class="form-control" placeholder="手机号码：" onkeyup="javascript:phoneCheck()" aria-describedby="basic-addon2">
  	</div>
  	<div id="ca" style="height: 30px;"></div>
  	<div class="input-group">
  		<span class="input-group-addon" ><font color="red">*</font></span>
  	...
  	<div  id="pwdcr" style="height: 30px;"></div>
  	<div class="input-group">
  	...
  	<div class="input-group">
  		<span class="input-group-addon" ></span>
  		<input name="zcuser.loc" type="text" class="form-control" placeholder="所在省市地区：" aria-describedby="basic-addon2">
  	</div>
  	<div  style="height: 30px;"></div>
